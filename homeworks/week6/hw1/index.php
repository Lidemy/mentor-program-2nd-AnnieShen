    ...
    ?>
        ...
        <div class="main_reply list">
          ...
          <div class="userInfo"> 
            ...
            <div class='show_content'><?php echo htmlspecialchars($row ["content"], ENT_QUOTES, 'utf-8'); ?>
            ...
            if($result2 -> num_rows>0 ){
              while($row2 = $result2 -> fetch_assoc() ){ //fetch_assoc 會逐一搜尋 找不到結束while
                ...
                ?>
                    ...
                    <div class='show_content_child'><?php echo htmlspecialchars($row2 ["content"], ENT_QUOTES, 'utf-8'); ?>
